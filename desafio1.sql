...
CREATE TABLE SpotifyClone.account(
	...
	account_value DECIMAL(5,2) NOT NULL
);
...
CREATE TABLE SpotifyClone.user(
  ...
  FOREIGN KEY (account_id) REFERENCES SpotifyClone.account(account_id)
);
...
INSERT INTO SpotifyClone.account (account_name, account_value)
VALUES 
	('gratuito', 0),
	('familiar', 7.99),
	('universitário', 5.99),
...
INSERT INTO SpotifyClone.user (account_id, user_name, age, account_date)
VALUES
	(1,'Thati', 23, DATE('2019-10-20')),
	(2,'Cintia', 35, DATE('2017-12-30')),
	(3,'Bill', 20, DATE('2019-06-05')),
	(4,'Roger', 45, DATE('2020-05-13')),
	(4,'Norman', 58, DATE('2017-02-17')),
	(2,'Patrick',33,DATE('2017-01-06')),
	(3,'Vivian',26,DATE('2018-01-05')),
	(3,'Carol',19,DATE('2018-02-14')),
	(2,'Angelina',42,DATE('2018-04-29')),
	(2,'Paul',46,DATE('2017-01-17'));
...
INSERT INTO SpotifyClone.album (artist_id,album_name, album_date)
VALUES
  (1,'Envious', 1990),
  (1,'Exuberant', 1993),
